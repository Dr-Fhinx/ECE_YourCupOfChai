...
REM
REM Generated by Vivado on Thu Dec 25 19:40:32 +0530 2025
...
echo "xvlog --incr --relax -prj CRC32_4bit_tb_vlog.prj"
call xvlog  --incr --relax -prj CRC32_4bit_tb_vlog.prj -log xvlog.log
