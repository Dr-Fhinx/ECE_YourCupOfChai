...
REM
REM Generated by Vivado on Fri Dec 26 14:07:40 +0530 2025
...
echo "xvlog --incr --relax -prj parser_vlog.prj"
call xvlog  --incr --relax -prj parser_vlog.prj -log xvlog.log
