...
HD_PWD='C:/Users/exspe/Acads/ECE_YourCupOfChai/PROJECTS/imageProcessing/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exec_nic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exec_nic.tcl
