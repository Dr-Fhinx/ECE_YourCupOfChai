...
REM
REM Generated by Vivado on Thu Dec 25 16:59:29 +0530 2025
...
echo "xvlog --incr --relax -prj uart_data_tb_vlog.prj"
call xvlog  --incr --relax -prj uart_data_tb_vlog.prj -log xvlog.log
