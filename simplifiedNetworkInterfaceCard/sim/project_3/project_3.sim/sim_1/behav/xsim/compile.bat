...
REM
REM Generated by Vivado on Thu Dec 25 17:40:07 +0530 2025
...
echo "xvlog --incr --relax -prj ipEnvelope_tb_vlog.prj"
call xvlog  --incr --relax -prj ipEnvelope_tb_vlog.prj -log xvlog.log
