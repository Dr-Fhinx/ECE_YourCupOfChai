...
REM
REM Generated by Vivado on Thu Dec 25 17:16:19 +0530 2025
...
echo "xvlog --incr --relax -prj udp_envelope_tb_vlog.prj"
call xvlog  --incr --relax -prj udp_envelope_tb_vlog.prj -log xvlog.log
