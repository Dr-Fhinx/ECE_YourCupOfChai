...
REM
REM Generated by Vivado on Fri Dec 26 12:48:33 +0530 2025
...
echo "xvlog --incr --relax -prj frame_tb_vlog.prj"
call xvlog  --incr --relax -prj frame_tb_vlog.prj -log xvlog.log
