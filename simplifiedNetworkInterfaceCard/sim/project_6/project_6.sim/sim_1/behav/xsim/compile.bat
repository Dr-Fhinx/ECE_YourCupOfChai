...
REM
REM Generated by Vivado on Fri Dec 26 13:35:55 +0530 2025
...
echo "xvlog --incr --relax -prj nibble_stitcher_tb_vlog.prj"
call xvlog  --incr --relax -prj nibble_stitcher_tb_vlog.prj -log xvlog.log
